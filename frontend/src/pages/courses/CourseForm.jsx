      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div>
          <h2 className="mb-0 fw-semibold" style={{ color: '#1a1a2e' }}>
            <i className="bi bi-book-plus me-2 text-primary"></i>
            Create New Course
          </h2>
          <p className="mb-0 mt-1" style={{ color: '#6c757d' }}>Enter course details to create a new record</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-4 pt-3 d-flex justify-content-end gap-2">
              ...
              <button type="submit" className="btn px-4 py-2" disabled={isLoading} style={{ backgroundColor: '#0d6efd', color: '#ffffff', border: 'none' }}>
                {isLoading ? <><span className="spinner-border spinner-border-sm me-2"></span>Creating...</> : 'Create Course'}
              </button>
            </div>
          </form>
        </div>
